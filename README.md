...
🥘 Image Classificaiton | Thai Foods (Private) | Trained Triplet model based on EfficientNet to create Thai Food images' embedding vector | 2022 | Coming soon
...
📷 Object Detection | Underwater Object (Private) | Fine-tuned YoloV5 and EfficientDet to classify Underwater object in TensorFlow Lite and Pytorch and deployed to FastAPI | 2021 | [Project Repo](https://github.com/new5558/arv-hackaton-deployment)
🧠 Image Classification | Intracranial Hemorrhage MRI Images(Private) | Trained ResNet50 and ResNext to detect Intracranial Hemorrhage symptomps | 2020 | Private
...
🤷‍♀️ Text Calssification | Chula courses description | Trained LSTM, TFIDF-SVM, Thai2Fit-SVM and, WangchanBERTa to calssify Chula course faculty from its description | 2021 | [Demo Repo](https://github.com/new5558/chula-course-faculty-prediction-demo)
📚 Semantic textual similarity | Chula courses description | Utilized Sentence Transformers to fine-tune SimCSE, WangchanBERTa, XLM-RoBERTa to calculate cosine similaity of courses in Chulalonkorn Univerisy from its Thai description | 2021 | [Demo Repo](https://github.com/new5558/chula-course-recommender-demo)

#### Time series
Topic | Dataset | Description | Year | Code
------| ------- | ----------- | ---- | -----
😶‍🌫️ EEG Brain wave classification | OpenBMI | Trained EEGNet, DeepCovNet, and Custom 1DCNN architecture to classify motor event from brain wave | 2022 | Coming soon
🏭 Predictive Maintenance | Accelometer Data (Private) | Utilized Explainalbe AI (Integrated gradients) to interpret DeepCovNet prediction of faulty motors | 2022 | Coming soon
...
🆎 AB Testing | CU GetReg Click Stream data (Private) | Created a succesful experiment between Random and Cosine varaint of recommender systems | 2022 |  [CU GetReg website](https://cugetreg.com/)
